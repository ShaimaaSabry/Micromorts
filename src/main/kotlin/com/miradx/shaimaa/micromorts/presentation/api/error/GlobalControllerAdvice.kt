...
import com.miradx.shaimaa.micromorts.domain.exception.BusinessRuleViolationException
...
class GlobalControllerAdvice {
    ...
    fun handle400ValidationException(ex: MethodArgumentNotValidException): ErrorResponse {
        ...
        val errorMessage = errors.takeIf { it.isNotEmpty() }?.let {
            "${it.keys.firstOrNull()} ${it.values.firstOrNull()}"
        } ?: "Validation error"
